...
from forms import RegistrationForm, LoginForm, ProductForm, UpdateProductForm  # Import the new form
...
def remove_from_cart(item_id):
    ...
    if cart_item and cart_item.user_id == current_user.id:
        ...
        product.stock += cart_item.quantity  # Restock when item is removed from the cart
